...
from pyprika.framework.event_bus_container import EventBusContainer

event_bus_container = EventBusContainer(EventBus())
...
class Pyprika:
    ...
    def __init__(self, username, password, fetch_delay=timedelta(hours=2)):
        ...
        background_refresh = BackgroundRefreshData(fetch_data, fetch_delay.total_seconds(), True)
    ...
    def get_recipes(
            ...
            name_like=None,
            name_not_like=None):
        return self._work_unit_container.create_filter_specifications(
